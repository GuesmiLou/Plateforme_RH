...
def run():
    ...
    offre1 = OffreEmploi.objects.create(
        ...
        nombre_postes=2,
        avantages="Tickets restaurant, prime de rendement trimestrielle, assurance groupe à 100%.",
    ...
    offre2 = OffreEmploi.objects.create(
        ...
        nombre_postes=1,
        avantages="Horaires flexibles, télétravail 2j/semaine, budget formation 1000 TND/an, MacBook Pro fourni.",
